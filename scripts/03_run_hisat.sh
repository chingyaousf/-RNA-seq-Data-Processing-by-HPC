...
hisat2 -p $NUMBER_OF_PROCESSORS --dta-cufflinks -x $REF_GENOME  --rna-strandness $RNA_STRANDNESS -1 $SAMPLE1_R1 -2 $SAMPLE1_R2 -S $SAMPLE1_SAM_OUTFILE
samtools sort -@ $NUMBER_OF_PROCESSORS -o $SAMPLE1_BAM_OUTFILE $SAMPLE1_SAM_OUTFILE

#hisat2 -p NUMBER_OF_PROCESSORS --data-cufflinks -x $REF_GENOME --rna-strandness $RNA_STRANDNESS -1 $SAMPLE1_R1 -2 $SAM
#PLE1_R2 -S $SAMPLE1_SAM_OUTFILE
